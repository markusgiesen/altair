	...
	grunt.config('concat', {
		...
		dist: {
			...
			files: {
				...
				'<%= project.scripts_dev %>/main.scripts.dev.js': ['<%= jsfiles.main.checks %>', '<%= jsfiles.main.polyfills %>', '<%= jsfiles.main.plugins %>', '<%= jsfiles.main.other %>'],
				'<%= project.scripts_dev %>/mobile.scripts.dev.js': ['<%= jsfiles.mobile.checks %>', '<%= jsfiles.mobile.polyfills %>', '<%= jsfiles.mobile.plugins %>', '<%= jsfiles.mobile.other %>'],
			},
		},
		forhint: {
			files: {
