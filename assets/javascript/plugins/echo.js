window.Echo = (function (global, document, undefined) {
	...
	var init = function (obj) {
		...
		if (document.addEventListener) {
			// Use _underscore throttle function to pollImages, little better performance than the _throttle from echo.js
			var debouncedPollImages = _.throttle(_pollImages,150);
			global.addEventListener('scroll', debouncedPollImages, false);
			global.addEventListener('load', debouncedPollImages, false);
			// Comment old code
